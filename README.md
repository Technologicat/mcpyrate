...
- [mcpyrate](#mcpyrate)
    ...
    - [Install & uninstall](#install--uninstall)
        ...
        - [Development mode (for developing `mcpyrate` itself)](#development-mode-for-developing-mcpyrate-itself)
            - [Install PDM in your Python environment](#install-pdm-in-your-python-environment)
            - [Install the isolated venv](#install-the-isolated-venv)
            - [Upgrade dependencies (later)](#upgrade-dependencies-later)
            - [Develop](#develop)
        - [Uninstall](#uninstall)
