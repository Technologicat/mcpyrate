...
**3.6.2** (in progress, last updated 25 September 2024)
...
Near-term focus will likely be on introducing support for Python 3.11 and 3.12, with no major changes to functionality.
